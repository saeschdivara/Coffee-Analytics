...
(function() {
  ...
  Sa = function(a) {
    var b;
    b = P(a, ga_transport_url) || get_analytics_address() + "/collect";
  ...
  Yc = function(a) {
    ...
    if (a.get(ga_legacy_history_import)) {
      ...
      c = P(a, ga_legacy_cookie_domain) || get_clean_host_name();
      d = Xc("__utma", c, b);
      if (d) {
        set_meta_data(19);
  ...
  Jc = function(a, b) {
    ...
    if (P(a, ga_storage) === "cookie") {
      ...
      if (c) {
        ...
        d = P(a, ga_legacy_cookie_domain) || get_clean_host_name();
        c = Xc("__utma", d, c);
        if (c === 0) {
          c = 0;
        } else {
  ...
  Kc = function(a) {
    ...
    if (document_location && a.get(ga_allow_anchor) && location_hash) {
      ...
      for (_i = 0, _len = location_hash.length; _i < _len; _i++) {
        ...
        if (starts_with(term_to_check, "utm_id") || starts_with(term_to_check, "utm_campaign") || starts_with(term_to_check, "utm_source") || starts_with(term_to_check, "utm_medium") || starts_with(term_to_check, "utm_term") || starts_with(term_to_check, "utm_content") || starts_with(term_to_check, "gclid") || starts_with(term_to_check, "dclid") || starts_with(term_to_check, "gclsrc")) {
