...
(function() {
  ...
  Ja = function(a) {
    if (100 !== a.get(ga_sample_rate) && La(P(a, ga_client_id)) % 10000 >= 100 * R(a, ga_sample_rate)) {
      throw "abort";
    }
  };
