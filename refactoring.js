...
(function() {
  ...
  add_function_to_object = function(a, b, c, d) {
    return b[a] = function() {
      var ca, g;
      try {
        if (d) {
  ...
  Z.v = function(a) {
    ...
    try {
      if (a.u) {
        return a.u.call(window, $.getByName("t0"));
      } else {
        if (gb === a.c) {
          b = $;
        } else {
  ...
  $.on_visible = function() {
    var b, c, d, ga_object, script_elements;
    if ("ga" !== gb) {
      set_meta_data(49);
    }
    ga_object = window[gb];
    if (!ga_object || ga_object.answer !== 42) {
      $.L = ga_object && ga_object.l;
      $.loaded = true;
      b = window[gb] = $;
      ...
      while (c < script_elements.length && c < 100) {
        ...
        if (d) {
          if (!starts_with(d, "https://www.google-analytics.com/analytics")) {
            d = false;
          } else {
            d = true;
          }
      ...
      ga_object = ga_object && ga_object.q;
      if (is_array(ga_object)) {
        return Z.ga_main_func.apply($, ga_object);
      } else {
  ...
  on_start_up = function() {
    ...
    if (!call_func_when_no_pre_render($.on_visible)) {
      set_meta_data(16);
      visibilty_is_not_prerender = false;
      on_visible_callback = function() {
        if (!visibilty_is_not_prerender && call_func_when_no_pre_render($.on_visible)) {
