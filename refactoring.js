...
(function() {
  ...
  Sa = function(a) {
    ...
    return a.set(ga_hit_callback, ua, true);
  };
  ...
  pc = (function() {
    function pc(a) {
      ...
      b(ga_cookie_domain, a[ga_cookie_domain] || xa());
