  ...
  Ga = function(url_string, data, c, d) {
    ...
    if (!d) {
      if (2036 >= data.length) {
        ...
        return send_plain_request(url_string, data, c) || send_cross_domain_request(url_string, data, c) || create_invisible_iframe(data, c) || c();
      } else {
